...
export const currentRoute = {
  ...
  points: [
    routePoint({ id: 'milan_entry', lon: 9.13, lat: 45.49, roadType: 'urban', speedLimit: 50, trafficState: 'slow' }),
    ...
    routePoint({ id: 'a4_brescia', lon: 10.18, lat: 45.52, roadType: 'motorway', speedLimit: 130, trafficState: 'normal' }),
    routePoint({ id: 'verona_corridor', lon: 11.0, lat: 45.44, roadType: 'motorway', speedLimit: 130, trafficState: 'normal', scenic: true }),
    routePoint({ id: 'venice_approach', lon: 12.22, lat: 45.47, roadType: 'primary', speedLimit: 70, trafficState: 'slow', bridge: true, layer: 1 }),
    routePoint({ id: 'venice_rialto', lon: landmarkById.get('venice_rialto').lon, lat: landmarkById.get('venice_rialto').lat, landmarkId: 'venice_rialto', roadType: 'pedestrian_context', speedLimit: 20, trafficState: 'slow', bridge: true, layer: 1 }),
    routePoint({ id: 'padova_south', lon: 11.88, lat: 45.2, roadType: 'motorway', speedLimit: 110, trafficState: 'normal' }),
    routePoint({ id: 'bologna_pass', lon: 11.34, lat: 44.5, roadType: 'motorway', speedLimit: 110, trafficState: 'normal' }),
    routePoint({ id: 'apennine_ridge', lon: 11.23, lat: 44.03, roadType: 'mountain_motorway', speedLimit: 90, trafficState: 'normal', tunnel: true, layer: -1, scenic: true }),
    ...
    routePoint({ id: 'pisa_west', lon: 10.58, lat: 43.72, roadType: 'primary', speedLimit: 70, trafficState: 'normal' }),
    ...
    routePoint({ id: 'tuscany_south', lon: 11.32, lat: 42.95, roadType: 'primary', speedLimit: 80, trafficState: 'normal', scenic: true }),
    routePoint({ id: 'rome_ring', lon: 12.42, lat: 41.94, roadType: 'ring_road', speedLimit: 90, trafficState: 'traffic_jam' }),
    ...
    routePoint({ id: 'naples_approach', lon: 14.25, lat: 40.9, roadType: 'urban_motorway', speedLimit: 80, trafficState: 'slow' }),
...
const segmentSeed = [
  ...
  { id: 'venice_lagoon', from: 'venice_approach', to: 'venice_rialto', type: 'bridge', trafficState: 'slow', speedLimit: 50, description: 'lagoon approach on an elevated deck' },
